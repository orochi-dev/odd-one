...
describe("NotFound", () => {
  it("offers clear recovery paths", () => {
    ...
    expect(screen.getByText(/the page may have moved, or the room link may be incomplete or mistyped. choose a lobby or paste the full room link again/i)).toBeInTheDocument();
