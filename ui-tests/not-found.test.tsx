...
describe("NotFound", () => {
  it("offers clear recovery paths", () => {
    ...
    expect(screen.getByText(/the page may have moved, or the room link may be missing a character. open a lobby or paste the room link again/i)).toBeInTheDocument();
