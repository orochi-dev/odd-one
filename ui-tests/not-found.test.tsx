...
describe("NotFound", () => {
  it("offers clear recovery paths", () => {
    ...
    expect(screen.getByText(/the page may have moved, the room link may be incomplete or mistyped, or the room may belong to the other network. choose a lobby or reopen the full celo or stacks room link/i)).toBeInTheDocument();
