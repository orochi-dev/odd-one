...
describe("NotFound", () => {
  it("offers clear recovery paths", () => {
    ...
    expect(screen.getByText(/the page may have moved, or the room link may be missing a character. start from a lobby to paste the room code again/i)).toBeInTheDocument();
