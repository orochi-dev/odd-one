...
export function LandingDemo() {
  ...
  return <section className="demo-stage" role="region" aria-label="Simulated Odd One round">
    ...
    </> : <div className="demo-result" role="status" aria-live="polite"><p>{resultCopy}</p><button type="button" className="text-button" onClick={() => setRevealed(false)}>Reset the preview</button></div>}
  </section>;
}
