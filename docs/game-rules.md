...
Unlisted removes a room from ordinary application discovery, but anyone with the direct room link can still open it. It is not privacy or access control: wallet addresses, commitments, reveals, timestamps, and results remain public onchain.
