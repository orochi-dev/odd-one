...
export default function Home() {
  return <div className="landing">
    ...
    <main id="main-content">
      ...
      <section className="final-cta section-wrap"><span className="eyebrow">Think you know what they will pick?</span><h2>There is only one<br/>way to find out.</h2><Link className="action action-orange" href="/play">Enter the show <ArrowRight aria-hidden="true" focusable="false" size={20}/></Link></section>
    </main>
