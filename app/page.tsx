...
export default function Home() {
  return <div className="landing">
    ...
    <header className="landing-nav" aria-label="Odd One homepage"><BrandMark /><nav aria-label="Homepage sections and lobby"><a aria-label="Jump to the Odd One rules and timeline" href="#rules">How it works</a><a aria-label="Jump to the Celo and Stacks network overview" href="#onchain">Networks</a><Link aria-label="Choose a lobby from the homepage navigation" className="nav-play" href="/play">Choose a lobby</Link></nav></header>
    <main id="main-content" tabIndex={-1}>
      <section className="hero section-wrap" aria-labelledby="hero-title">
        <div className="hero-copy"><span className="eyebrow">A 30-minute game of nerve</span><h1 id="hero-title">Go low.<br/><em>Stay unique.</em></h1><p>Pick a number nobody else will. When the curtain lifts, the lowest number standing alone takes the room.</p><div className="hero-actions"><Link aria-label="Choose a lobby and start playing Odd One" className="action action-lime" href="/play">Choose a lobby <ArrowRight aria-hidden="true" focusable="false" size={18}/></Link><a aria-label="Learn how Odd One works" className="action action-ghost" href="#rules">Learn the trick</a></div><ul className="hero-proof" aria-label="Odd One quick facts"><li>No entry fee</li><li>3–12 players</li><li>Celo + Stacks</li></ul></div>
        <LandingDemo />
      </section>
      ...
      <section className="timeline-section" aria-labelledby="timeline-title"><div className="section-wrap timeline-wrap"><div><span className="eyebrow">The whole show</span><h2 id="timeline-title">Thirty minutes.<br/>No host advantage.</h2><p>The clock starts when the room is created and never pauses, even when all twelve seats fill.</p></div><ol className="timeline" aria-label="Odd One round timeline"><li className="timeline-segment pick"><strong>20:00</strong><span>Secret pick phase</span></li><li className="timeline-segment reveal"><strong>10:00</strong><span>Public reveal phase</span></li><li className="timeline-finish"><strong aria-hidden="true">↓</strong><span>Anyone can settle</span></li></ol></div></section>
      ...
      <section className="rooms-section section-wrap" aria-labelledby="room-visibility-title"><h2 id="room-visibility-title" className="sr-only">Public and unlisted room visibility</h2><article aria-labelledby="public-room-title" aria-describedby="public-room-copy" className="room-mode public"><Radio aria-hidden="true" focusable="false"/><span className="eyebrow">Public rooms</span><h3 id="public-room-title">Walk into the spotlight.</h3><p id="public-room-copy">Listed in the lobby for anyone ready to join a live room.</p></article><article aria-labelledby="unlisted-room-title" aria-describedby="unlisted-room-copy" className="room-mode unlisted"><LockKeyhole aria-hidden="true" focusable="false"/><span className="eyebrow">Unlisted rooms</span><h3 id="unlisted-room-title">Send the signal yourself.</h3><p id="unlisted-room-copy">Share the direct link. Unlisted is quieter, never private—blockchain activity remains public.</p></article></section>

      <section id="onchain" className="chain-section section-wrap" aria-labelledby="onchain-title" aria-describedby="onchain-copy onchain-celo-copy onchain-stacks-copy"><div className="chain-copy"><span className="eyebrow">Same game. Two stages.</span><h2 id="onchain-title">Celo in MiniPay.<br/>Stacks beside Bitcoin.</h2><p id="onchain-copy">Your rooms and scores live independently on each network. There is no account server, indexer, or hidden operator.</p></div><div className="chain-panels"><article><span className="chain-letter">C</span><h3>Celo</h3><p id="onchain-celo-copy">Fast mobile play with automatic MiniPay wallet access.</p></article><article><span className="chain-letter stacks">S</span><h3>Stacks</h3><p id="onchain-stacks-copy">Clarity-native rooms with the same timing and scoring rules.</p></article></div></section>

      <section className="public-section section-wrap" aria-labelledby="public-disclosure-title"><div className="public-stamp" aria-hidden="true">PUBLIC<br/>BY DESIGN</div><div><span className="eyebrow">Before you enter</span><h2 id="public-disclosure-title">The chain remembers the room.</h2><p>Wallet addresses, commitments, revealed numbers, timestamps, and results are public and permanent. Your secret salt stays in your browser until you reveal it.</p></div></section>
