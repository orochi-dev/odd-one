...
export default function Home() {
  return <div className="landing">
    ...
    <footer className="landing-footer"><BrandMark decorative /><p>A free strategy game. No bets, prizes, or financial value.</p><span className="mono">ODD ONE / 2026</span></footer>
  </div>;
}
