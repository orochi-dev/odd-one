...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Odd One", description: "A free 30-minute strategy game for 3-12 players on Celo and Stacks with no entry fee or prize pool. Go low. Stay unique.", siteName: "Odd One", images: [{ url: "/og.png", width: 1200, height: 630, alt: "Odd One strategy game preview art with the tagline Go low. Stay unique." }], type: "website" },
  twitter: { card: "summary_large_image", title: "Odd One — Go low. Stay unique.", description: "A free 30-minute strategy game for 3-12 players on Celo and Stacks with no entry fee or prize pool. Pick a low number, reveal it, and hope nobody thought like you.", images: [{ url: "/og.png", alt: "Odd One strategy game preview art with the tagline Go low. Stay unique." }] },
