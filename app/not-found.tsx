...
export default function NotFound() {
  return <main className="center-screen" role="alert" aria-labelledby="not-found-title" aria-describedby="not-found-copy">
    ...
    <p id="not-found-copy">The page may have moved, or the room link may no longer be valid.</p>
