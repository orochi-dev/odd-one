...
export default function NotFound() {
  return <main className="center-screen" aria-labelledby="not-found-title" aria-describedby="not-found-copy">
    ...
    <p id="not-found-copy">The page may have moved, the room link may be incomplete or mistyped, or the room may belong to the other network. Room links stay separate on Celo and Stacks, so reopen the full link or jump straight into the correct lobby.</p>
